...
public interface MemoryAllocator {
     ...
     * @throws OutOfMemoryException 分配器可分配空间不足时抛出
     * @throws InterruptedException 等待过程中被中断抛出
     */

    Memory allocate(int size) throws OutOfMemoryException, InterruptedException;
    ...
    Memory allocate(int size, long timeout, TimeUnit unit)
        throws OutOfMemoryException, InterruptedException;
    ...
    class UnboundedMemoryAllocator implements MemoryAllocator {
        ...
        @Override
        public Memory allocate(int size) throws OutOfMemoryException, InterruptedException {
    ...
    class BoundedMemoryAllocator implements MemoryAllocator {
        ...
        public Memory allocate(int size, long timeout, TimeUnit unit)
            ...
            if (!tryRequest(size, timeout, unit)) {
                ...
                throw new OutOfMemoryException("allocate failed. available space not enough.");
            }
        ...
        private void startCleaner() {
            ...
            cleaner.setName("MemoryAllocator-Cleaner");
