 ...
 * 腾讯内部北极星接入
 */
public class TencentPolarisEndpointResolver implements RetryableEndpointResolver, HandlerAfterProcess {
    private static final Logger LOG = LoggerFactory.getLogger(TencentPolarisEndpointResolver.class);
    ...
    public TencentPolarisEndpointResolver(String namespace, String service) {
    ...
    @Override
    public TencentPolarisEndpointResolver withMaxRetries(int maxRetries) {
