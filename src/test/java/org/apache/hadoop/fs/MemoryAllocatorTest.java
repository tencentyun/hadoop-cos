...
import org.apache.hadoop.fs.MemoryAllocator.Memory;
...
class MemoryAllocatorTest {
    ...
    @Test
    public void test1() throws InterruptedException, OutOfMemoryException {
        ...
        assertThrowsExactly(OutOfMemoryException.class, new Executable() {
            @Override
    ...
    public void test2() {
        ...
        assertEquals(0, unboundedMemoryAllocator.getTotalBytes());
